 ...
 */
export type PrivateGetLiquidatorHistory = PrivateGetLiquidatorHistoryJSONRPCSchema;
export type HttpMethod = "POST";
export type Method = "private/get_liquidator_history";
/**
...
export interface PrivateGetLiquidatorHistoryJSONRPCSchema {
  request: PrivateGetLiquidatorHistoryRequestSchema;
  response: PrivateGetLiquidatorHistoryResponseSchema;
}
export interface PrivateGetLiquidatorHistoryRequestSchema {
  httpMethod: HttpMethod;
  id?: string | number;
  method: Method;
  params: PrivateGetLiquidatorHistoryParamsSchema;
}
export interface PrivateGetLiquidatorHistoryParamsSchema {
...
export interface PrivateGetLiquidatorHistoryResponseSchema {
  id: string | number;
  result: PrivateGetLiquidatorHistoryResultSchema;
}
export interface PrivateGetLiquidatorHistoryResultSchema {
  bids: Bids;
