...
export interface PrivateCancelJSONRPCSchema {
  ...
  response: PrivateCancelResponseSchema;
}
export interface PrivateCancelRequestSchema {
  httpMethod: HttpMethod;
  id?: string | number;
  method: Method;
  params: PrivateCancelParamsSchema;
}
export interface PrivateCancelParamsSchema {
  instrument_name: InstrumentName;
  order_id: OrderId;
  subaccount_id: SubaccountId;
}
export interface PrivateCancelResponseSchema {
  id: string | number;
  result: PrivateCancelResultSchema;
}
export interface PrivateCancelResultSchema {
  amount: Amount;
