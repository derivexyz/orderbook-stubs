 ...
 */
export type PrivateCancelTriggerOrder = PrivateCancelTriggerOrderJSONRPCSchema;
export type HttpMethod = "POST";
export type Method = "private/cancel_trigger_order";
...
export interface PrivateCancelTriggerOrderJSONRPCSchema {
  request: PrivateCancelTriggerOrderRequestSchema;
  response: PrivateCancelTriggerOrderResponseSchema;
}
export interface PrivateCancelTriggerOrderRequestSchema {
  httpMethod: HttpMethod;
  id?: string | number;
  method: Method;
  params: PrivateCancelTriggerOrderParamsSchema;
}
export interface PrivateCancelTriggerOrderParamsSchema {
  order_id: OrderId;
  subaccount_id: SubaccountId;
}
export interface PrivateCancelTriggerOrderResponseSchema {
  id: string | number;
  result: PrivateCancelTriggerOrderResultSchema;
}
export interface PrivateCancelTriggerOrderResultSchema {
  amount: Amount;
