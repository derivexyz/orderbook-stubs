 ...
 */
export type IsRfqMaker = boolean;
...
export interface PrivateGetAccountResultSchema {
  ...
  is_rfq_maker: IsRfqMaker;
  per_endpoint_tps: PerEndpointTps;
  ...
  websocket_option_tps: WebsocketOptionTps;
  websocket_perp_tps: WebsocketPerpTps;
}
/**
 * If a particular endpoint has a different max TPS, it will be specified here
 */
export interface PerEndpointTps {
  [k: string]: any;
}
