...
/**
 * Although a REST endpoint, currently only accessible via WS to stay consistent with WS only orders.<br /><br />This RPC only saves trigger orders to database. See TriggerOrderWorker for order execution.
 * Required minimum session key permission level is `admin`
 */
export type PrivateTriggerOrder = PrivateTriggerOrderJSONRPCSchema;
export type HttpMethod = "POST";
export type Method = "private/trigger_order";
/**
 ...
 */
export type TriggerPrice = string;
/**
...
export interface PrivateTriggerOrderJSONRPCSchema {
  request: PrivateTriggerOrderRequestSchema;
  response: PrivateTriggerOrderResponseSchema;
}
export interface PrivateTriggerOrderRequestSchema {
  httpMethod: HttpMethod;
  id?: string | number;
  method: Method;
  params: PrivateTriggerOrderParamsSchema;
}
export interface PrivateTriggerOrderParamsSchema {
  amount: Amount;
  conn_id: ConnId;
  direction: Direction;
...
export interface PrivateTriggerOrderResponseSchema {
  id: string | number;
  result: PrivateTriggerOrderResultSchema;
}
export interface PrivateTriggerOrderResultSchema {
