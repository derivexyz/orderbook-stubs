 ...
 */
export type PublicOrderQuote = PublicOrderQuoteJSONRPCSchema;
export type HttpMethod = "POST";
export type Method = "public/order_quote";
/**
...
export interface PublicOrderQuoteJSONRPCSchema {
  request: PublicOrderQuoteRequestSchema;
  response: PublicOrderQuoteResponseSchema;
}
export interface PublicOrderQuoteRequestSchema {
  httpMethod: HttpMethod;
  id?: string | number;
  method: Method;
  params: PublicOrderQuoteParamsSchema;
}
export interface PublicOrderQuoteParamsSchema {
  amount: Amount;
  direction: Direction;
...
export interface PublicOrderQuoteResponseSchema {
  id: string | number;
  result: PublicOrderQuoteResultSchema;
}
export interface PublicOrderQuoteResultSchema {
