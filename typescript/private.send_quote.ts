 ...
 */
export type PrivateSendQuote = PrivateSendQuoteJSONRPCSchema;
export type HttpMethod = "POST";
export type Method = "private/send_quote";
/**
...
export interface PrivateSendQuoteJSONRPCSchema {
  request: PrivateSendQuoteRequestSchema;
  response: PrivateSendQuoteResponseSchema;
}
export interface PrivateSendQuoteRequestSchema {
  httpMethod: HttpMethod;
  id?: string | number;
  method: Method;
  params: PrivateSendQuoteParamsSchema;
}
export interface PrivateSendQuoteParamsSchema {
  direction: Direction;
  label?: Label;
  legs: Legs;
  max_fee: MaxFee;
...
export interface PrivateSendQuoteResponseSchema {
  id: string | number;
  result: PrivateSendQuoteResultSchema;
}
export interface PrivateSendQuoteResultSchema {
