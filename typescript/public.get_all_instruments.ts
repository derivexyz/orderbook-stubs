 ...
 */
export type PublicGetAllInstruments = PublicGetAllInstrumentsJSONRPCSchema;
export type HttpMethod = "POST";
export type Method = "public/get_all_instruments";
/**
...
export interface PublicGetAllInstrumentsJSONRPCSchema {
  request: PublicGetAllInstrumentsRequestSchema;
  response: PublicGetAllInstrumentsResponseSchema;
}
export interface PublicGetAllInstrumentsRequestSchema {
  httpMethod: HttpMethod;
  id?: string | number;
  method: Method;
  params: PublicGetAllInstrumentsParamsSchema;
}
export interface PublicGetAllInstrumentsParamsSchema {
  currency: Currency;
  expired: Expired;
...
export interface PublicGetAllInstrumentsResponseSchema {
  id: string | number;
  result: PublicGetAllInstrumentsResultSchema;
}
export interface PublicGetAllInstrumentsResultSchema {
